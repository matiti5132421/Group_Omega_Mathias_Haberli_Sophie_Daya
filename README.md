...
4. [K-Nearest Neighbors (KNN) Model](#k-nearest-neighbors-knn-model)
   - [Definition of the Model](#definition-of-the-model-1)
   - [Code Explanation](#code-explanation-1)
   - [Metrics and Results](#metrics-and-results-1)
5. [Decision Tree Model](#decision-tree-model)
   - [Definition of the Model](#definition-of-the-model-2)
   - [Code Explanation](#code-explanation-2)
   - [Metrics and Results](#metrics-and-results-2)
6. [Random Forest Model](#random-forest-model)
   - [Definition of the Model](#definition-of-the-model-3)
   - [Code Explanation](#code-explanation-3)
   - [Metrics and Results](#metrics-and-results-3)
7. [CamemBERT Model](#camembert-model)
   - [Definition of the Model](#definition-of-the-model-4)
   - [Code Explanation](#code-explanation-4)
   - [Metrics and Results](#metrics-and-results-4)
8. [Results](#results)
